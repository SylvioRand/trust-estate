...
| Feedback post-visite      | ✅ (simplifié)  | Version avancée    |
...
- caractéristiques
- score de confiance
- ~~historique (vendu / loué)~~ → **Post-MVP**
...
- ~~téléphone vérifié~~ → **Post-MVP** (en MVP : tous peuvent réserver)
...
> **Post-MVP :** Fenêtre de feedback limitée à 7 jours après la visite
...
> **`Niveau_2.2_Parcours_Vendeur_Bailleur.md` — Section 1**
>
