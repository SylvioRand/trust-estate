# 📗 Niveau 2.2 — Parcours Vendeur / Bailleur — VERSION CORRIGÉE
...
| Fonctionnalité            | MVP                    |
|---------------------------|------------------------|
| Tableau de bord vendeur   | ✅ (simplifié)         |
| Création d'annonce        | ✅                     |
...
| Voir réservations émises (acheteur)| ✅     |
...
**Date :** Décembre 2024  
**Modifications :** Clarification MVP vs Post-MVP
